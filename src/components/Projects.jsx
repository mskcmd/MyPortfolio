...
const projects = [
  {
    ...
    description:
      "A comprehensive e-commerce platform for buying and exploring a wide range of furniture.",
    longDescription: `
  ...
  },
  {
    id: 2,
    title:
      "User Management System (CRUD) with JWT Authentication and Redux Toolkit",
    description:
      "A user management system with CRUD operations and secure JWT authentication.",
    longDescription: `
      ...
      `,
    image:
      "https://github.com/mskcmd/MERN_Stack_Auth/blob/main/mern-auth/frontend/public/download.png?raw=true",
  ...
  },
  {
    ...
    description:
      "A user management system featuring CRUD operations with session management and authentication.",
    longDescription: `
      ...
      `,
    image:
      "https://www.webstackacademy.com/wp-content/uploads/2023/01/Backend-Hero-1.png",
    githubLink:
      "https://github.com/yourusername/user-management-system-session",
  ...
  },
  {
    ...
    title: "Netflix Clone",
    description:
      "A Netflix-like web application with a modern UI and YouTube integration.",
    longDescription: `
      ...
      `,
    image:
      "https://wallpapercat.com/w/middle-retina/2/5/1/45994-3000x2003-desktop-hd-netflix-wallpaper-photo.jpg",
  ...
  },
  {
    ...
    title: "To-Do App",
    description:
      "A visually appealing To-Do application with CRUD functionalities.",
    longDescription: `
  ...
  },
  {
    ...
    description:
      "A beautifully responsive portfolio showcasing my skills with animations and live email functionality.",
    longDescription: `
        ...
        `,
    image:
      "https://github.com/mskcmd/MyPortfolio/blob/main/src/assets/image.png?raw=true",
    githubLink: "https://github.com/mskcmd/MyPortfolio?tab=readme-ov-file",
    liveLink:
      "https://my-portfoliosuhail-p05w4pdmf-mskcmds-projects.vercel.app/",
  ...
  },
  {
    ...
    description:
      "E-commerce application with Stripe payment integration for a seamless checkout experience.",
    longDescription: `
            This project integrates Stripe for payment processing, allowing users to add products to their cart and pay using Stripe's secure checkout system with webhook support.
            - Cart Functionality: Users can add products to their cart and proceed to payment.
            - Stripe Integration: Utilized Stripe for handling payments and webhook notifications for payment confirmation.
            - User-Friendly Design: Built using Bootstrap for a clean and responsive user interface.
            `,
    image:
      "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSoses6jAz57Kh6hOT2IgSP8hdxilB00L_WPQ&s", // Replace with the actual image URL if available
    githubLink: "https://github.com/mskcmd/stripe-payment-integration", // Replace with your actual GitHub link
    liveLink: "https://stripepaymentintegration.com", // Replace with your actual live project link
    technologies: ["React.js", "JavaScript", "Bootstrap", "Stripe"],
  },
  {
    id: 9,
    title: "BuzzChat",
    description:
      "A real-time chat application with both individual and group chat functionalities.",
    longDescription: `
            BuzzChat is a real-time chat application that allows users to engage in both individual and group conversations.
            - Real-time Communication: Leveraged Socket.IO to provide fast, reliable, and real-time chat capabilities.
            - Group and Individual Chat: Supports both group and one-on-one chat features.
            - User Interface: Built with Chakra UI for a clean and accessible design.
            `,
    image:
      "https://play-lh.googleusercontent.com/8xSX7C0edYgitTGwdbqgoB9jt5lp4nO7VY_jkE3jWUCypcugn5aRHSn9Y8-qQA53GSo", // Replace with the actual image URL if available
    githubLink: "https://github.com/mskcmd", // Replace with your actual GitHub link
    liveLink: "https://buzzchatapp.com", // Replace with your actual live project link
    technologies: [
      "React.js",
      "Socket.IO",
      "Express.js",
